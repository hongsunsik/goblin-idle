...
(function (root) {
  const ADVANCED3 = {
    ...
    paladin:     { name: '성기사',        parent: 'knight',      desc: '신성한 가호로 체력과 회복이 더 늘어난다.',
                   mult: { hp: 1.3, regen: 1.4, dmg: 1.15 } },
