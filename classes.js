...
(function (root) {
  ...
  const ADVANCED4 = {
    ...
    forestwarden:  { name: '숲의 수호자',   parent: 'beastmaster', desc: '숲과 함께 싸운다. 동료와 체력이 오른다.',
                     mult: { comp: 1.34, hp: 1.3, dmg: 0.83 } },
    // ---- 업화술사 ----
