...
- **수치:** 등급이 높을수록 크고 **±5% 무작위**이며(장비 창에 '품질 +3%'처럼 기준 대비 편차가 보임, 예전 ±15%는 같은 장비끼리 차이가 너무 커서 줄임), **높은 스테이지에서 얻을수록 커집니다**(스테이지 40에서 나온 장비는 스테이지 1의 약 2배). 전설 무기는 스테이지 40에서 공격력 +52% 안팎입니다.
